                ...
                {menuOpened && 
                    <motion.nav 
                        ...
                        <div  className={`flex flex-col gap-10 justify-center items-center w-full ${servicesVisible}`}>
                            ...
                            <Link className='hover:scale-105 text-center' href="/services/#Batiments et travaux publics" onClick={handleLinkClick} aria-label="Link to section Batiments et travaux publics">Batiments et travaux publics</Link>
                            <Link className='hover:scale-105 text-center' href="/services/#Immobilier" onClick={handleLinkClick} aria-label="Link to section Immobilier">Immobilier</Link>
                            <Link className='hover:scale-105 text-center' href="/services/#Évènements sportifs et culturels" onClick={handleLinkClick} aria-label="Link to section Événements sportifs et culturels">Évènements sportifs et culturels</Link>
                            <Link className='hover:scale-105 text-center' href="/services/#Tourisme" onClick={handleLinkClick} aria-label="Link to section Tourisme">Tourisme</Link>
                            <Link className='hover:scale-105 text-center' href="/services/#Évènements familiaux" onClick={handleLinkClick} aria-label="Link to section Événements familiaux">Évènements familiaux</Link>
                        </div>
