...
function ContactComponent () {
    ...
    const whatPage = (pathname === "/contact" ? "w-full flex items-center absolute sm:top-[20vh] top-[30vh] self-center justify-center" : "w-full flex items-center sm:absolute sm:top-[105vh] sm:self-center sm:justify-center")
    return (
